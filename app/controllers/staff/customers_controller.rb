class Staff::CustomersController < Staff::Base
  def index
    @search_form = Staff::CustomerSearchForm.new(search_form_params)
  ...
  def search_form_params
    params.fetch(:search, {}).permit(:family_name_kana, :given_name_kana, :birth_year, :birth_month, :birth_mday,
                                     :address_type, :prefecture, :city, :phone_number, :gender, :last_four_digits)
  end
end
